...
from fw_babi import FWQA_DeepBiLSTM
...
with tf.Session() as sess:
    model = FWQA_DeepBiLSTM(batch_size, vocab_size, sentence_size, memory_size, FLAGS.embedding_size, FLAGS.num_hidden_units, FLAGS.S, FLAGS.S_Q,
                 num_layers=FLAGS.num_layers, tied_output=FLAGS.tied_output, max_pooling=FLAGS.max_pooling, layer_norm=FLAGS.layer_norm,
                 forget_bias=FLAGS.forget_bias, session=sess, max_grad_norm=FLAGS.max_grad_norm, log_dir=FLAGS.log_dir)
